...
- To add <b><i><span style="color:#d46644">NAT</span></i></b> functionality to the <i><span style="color:#477bbe">host</span></i>, we use <b><i><span style="color:#d46644">IPTables</span></i></b>, adding a new rule in the post-[[0.1 - Switching, Routing, Gateways CNI in Kubernetes|routing]] chain to masquerade (or replace) the front <span style="color:#5c7e3e">IP address</span> on all packets coming from the source <b><i><span style="color:#d46644">network</span></i></b> with its own <span style="color:#5c7e3e">IP address</span>
	- This way, anyone receiving the packets outside of the <b><i><span style="color:#d46644">network</span></i></b> will think they're coming from the <i><span style="color:#477bbe">host</span></i> and not from within the <b><i><span style="color:#d46644">namespace</span></i></b>
